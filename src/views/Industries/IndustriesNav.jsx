...
const industryNavItems = [
  { id: 'it-tech', label: 'IT & Technology', icon: <Code2 size={18} /> },
  { id: 'non-it', label: 'Non-IT Industries', icon: <Building2 size={18} /> },
  { id: 'agencies', label: 'Recruitment Agencies', icon: <Briefcase size={18} /> },
];
