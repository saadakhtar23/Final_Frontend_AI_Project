...
function DonutScore({ value = 0, variant = "unfiltered" }) {
    ...
    <div className="bg-white w-full max-w-[450px] rounded-2xl shadow-xl border border-gray-100 overflow-hidden max-h-[90vh] overflow-y-auto">
      ...
      <div className="px-6 py-5">
        <div className="flex justify-center">
          <DonutScore value={candidate?.percentage || 0} variant="unfiltered" />
        </div>
        ...
        <div className="mt-6">
          {candidate?.resume ? (
            <a
              ...
              className="block w-full text-center text-white font-semibold py-3 rounded-xl bg-red-600 hover:bg-red-700 transition-colors"
            >
              View Resume
            </a>
          ) : (
