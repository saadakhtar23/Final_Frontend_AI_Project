...
const AdminHeader = ({ onMenuToggle }) => {
    ...
    const getNavTitle = () => {
        ...
        if (path.includes("/RecruiterManagement")) return "HR Administration";
        if (path.includes("/RMGManagement")) return "RMG Administration";
        if (path.includes("/Tickets")) return "Raise Tickets";
        if (path.includes("/RaiseTickets")) return "Create Tickets";
        return "Dashboard";
    };
